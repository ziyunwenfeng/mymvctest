...
<body>
	<jsp:useBean id="itemsCustom" scope="request"
		type="com.markliu.ssm.po.ItemsCustom" />

	<form id="itemForm"
		action="${pageContext.request.contextPath }/items/update_items"
		...
		<table width="100%" border=1>
			...
			<tr>
				<td>商品图片</td>
				<td><input type="file" name="pictureMultipartFile" value="上传图片" />
				</td>
