	...
	<form name="itemsForm" method="post">
		<table width="100%" border=1>
			<thead>
				<tr>
					...
					<td><input type="button" value="批量更新"
						onclick="batch_update_items()" /></td>
				</tr>
				<tr>
					<td>id</td>
					<td>name</td>
        ...
        --%>
				...
				<c:forEach items="${itemsCustomList }" var="itemsCustom">
					<tr>
						<td><input type="text" name="itemsCustomMap['id']"
							value="${itemsCustom.id}"></td>
						<td><input type="text" name="itemsCustomMap['name']"
							value="${itemsCustom.name}"></td>
						<td><input type="text" name="itemsCustomMap['price']"
							value="${itemsCustom.price}"></td>
						<td><input type="text" name="itemsCustomMap['picture']"
							value="${itemsCustom.picture}"></td>
						...
						<td><input type="text" name="itemsCustomMap['detail']"
